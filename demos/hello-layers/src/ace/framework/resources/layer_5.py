...
from ace.framework.prompts.outputs import l5_northbound_outputs, l5_southbound_outputs
...
class Layer5(Layer):
    ...
    def get_op_description(self, content):
        ...
        match south_op:
            ...
            case "TAKE_ACTION":
                south_op_description = take_action_control.render(layer_outputs=l5_southbound_outputs)
            case default:
        ...
        match north_op:
            ...
            case "TAKE_ACTION":
                north_op_description = take_action_data.render(layer_outputs=l5_northbound_outputs)
            case default:
